...
@section('content')
    ...
    <div class="container">
        ...
        <div class="box-common">
            <div class="box-common__top clearfix">
                <h2 class="box-common__title">Thương hiệu</h2>
            </div>
        ...
        <div class="dongho clearfix" style="background-color:#0c042d">
            <div class="dongho__left">
                <a aria-label="slide" data-cate="0" data-place="1576">
                    <img loading="lazy" class=" ls-is-cached lazyloaded" style="height: 390px; width: 210px"
                         alt="Banner Block laptop trang chủ"
                         src="{{ asset('images/banner_home.jpg') }}"></a>
            </div>
            <div class="dongho__right">
                <h4 style="color: rgb(226, 220, 220);font-family: inherit;font-weight: 700">Sản Phẩm Sale</h4>
{{--                <ul class="dongho-tab">--}}
